...
ggsave("residual_plots_11_terms.png", final_grid, width = 16, height = 12, dpi = 300)
cat("Image saved as: residual_plots_11_terms.png\n")
cat("This includes plots for all 10 predictors + 1 interaction term (11 total terms)\n")
cat("Note: Wood_Deck_SF not included as it's not available in the dataset\n")
```
